...
namespace FoulzExternal.storage
{
    internal static class Storage
    {
        ...
        public static string RobloxVersion { get; private set; } = string.Empty;
        ...
        public static void Initialize(Memory m)
        {
            if (m == null) return;
            ...
            try
            {
                ...
                try
                {
                    ...
                    RobloxVersion = ver.StartsWith("version-", StringComparison.OrdinalIgnoreCase) ? ver[8..] : ver;
                }
                catch { RobloxVersion = ""; }
                ...
                try { LocalPlayerUserId = LocalPlayerInstance.IsValid ? m.Read<long>(LocalPlayerInstance.Address + Player.UserId) : 0; } catch { LocalPlayerUserId = 0; }
        ...
        public static void Refresh(Memory m) => Initialize(m);
